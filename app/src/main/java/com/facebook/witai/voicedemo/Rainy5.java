...
public class Rainy5 extends AppCompatActivity {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch(which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        Intent intent = new Intent(Rainy5.this , Rainy1.class);
            ...
            public void onInit(int ttsStatus) {
                ...
                if (ttsStatus == TextToSpeech.SUCCESS) {
                    if (CLIENT_ACCESS_TOKEN == "<YOUR CLIENT ACCESS TOKEN>") {
                        ...
                        textToSpeech.speak("This is Foopy's recommended diet in rainy weather. This diet gives you energy in humid and rainy weather.", TextToSpeech.QUEUE_FLUSH, null, UUID.randomUUID().toString());
                    }
                }
            }
        });
