...
public class Cloudy3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cloudy3);
        ...
        button1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=lBhwjjUiFk4"));
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch(which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        Intent intent = new Intent(Cloudy3.this , Cloudy4.class);
            ...
            public void onInit(int ttsStatus) {
                ...
                if (ttsStatus == TextToSpeech.SUCCESS) {
                    if (CLIENT_ACCESS_TOKEN == "<YOUR CLIENT ACCESS TOKEN>") {
                        ...
                        textToSpeech.speak("This is Foopy's recommended diet in cloudy weather. When you feel down like the weather, eat this food and have a cozy day.", TextToSpeech.QUEUE_FLUSH, null, UUID.randomUUID().toString());
                    }
                }
            }
        });
