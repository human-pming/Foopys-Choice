...
public class Sunny4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sunny4);
        ...
        button1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=aASr5x0d3Ys"));
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch(which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        Intent intent = new Intent(Sunny4.this , Sunny5.class);
            ...
            public void onInit(int ttsStatus) {
                ...
                if (ttsStatus == TextToSpeech.SUCCESS) {
                    if (CLIENT_ACCESS_TOKEN == "<YOUR CLIENT ACCESS TOKEN>") {
                        ...
                        textToSpeech.speak("This is Foopy's recommended diet in sunny weather. This diet protects your body and makes it healthy in the heat", TextToSpeech.QUEUE_FLUSH, null, UUID.randomUUID().toString());
                    }
                }
            }
        });
