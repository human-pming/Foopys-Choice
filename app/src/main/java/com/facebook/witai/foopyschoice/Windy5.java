...
public class Windy5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_windy5);
        ...
        button1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=2sX4fCgg-UI"));
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch(which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        Intent intent = new Intent(Windy5.this , Windy1.class);
