...
public class Windy2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_windy2);
        ...
        button1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=JceGMNG7rpU"));
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch(which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        Intent intent = new Intent(Windy2.this , Windy3.class);
            ...
            public void onInit(int ttsStatus) {
                ...
                if (ttsStatus == TextToSpeech.SUCCESS) {
                    if (CLIENT_ACCESS_TOKEN == "<YOUR CLIENT ACCESS TOKEN>") {
                        ...
                        textToSpeech.speak("The diet I recommend is the food that will bring a cool breeze to your heart when you want to leave and fly away.", TextToSpeech.QUEUE_FLUSH, null, UUID.randomUUID().toString());
                    }
                }
            }
        });
