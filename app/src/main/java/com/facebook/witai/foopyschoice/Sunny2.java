...
public class Sunny2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sunny2);
        ...
        button1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=akcrkXYr61M"));
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch(which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        Intent intent = new Intent(Sunny2.this , Sunny3.class);
